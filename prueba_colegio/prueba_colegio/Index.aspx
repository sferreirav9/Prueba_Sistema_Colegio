    ...
    <div id="page-wrapper">
        ...
        <section id="banner" >
            <div class="inner">
                ...
                <p>
                    El genio se hace con 1% de talento<br />
                     y un 99% de<br />
                    Trabajo
                </p>
                <ul class="actions">
        ...
        <section id="one" class="wrapper style1 special">
            <div class="inner">
                ...
                <ul class="icons major">
                    <li><a href="vistas/Profesor/RegistroProfesor.aspx" class="button fit">Registrate Profesor</a></li>
                    <li><a href="vistas/Alumno/RegistrarAlumno.aspx" class="button fit">Registrate Alumno</a></li>
                </ul>
            </div>
        </section>
        <!-- CTA -->
